...
import type { Player, Expense, CoachSalary, Coach, RevenueItem } from "../../types"
...
export default function FinancialReport() {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6">
      ...
      <SearchInput placeholder="ابحث عن لاعب أو نفقة..." value={searchTerm} onChange={setSearchTerm} />
            ...
            {filteredExpenses.length > 0 ? (
              ...
              <tr>
                <td colSpan={4} className="py-3 px-6 text-center">
                  لا توجد نفقات مطابقة لعملية البحث
                </td>
              </tr>
            )}
          </tbody>
      ...
      {editingPlayer && (
        <EditPlayerModal player={editingPlayer} onClose={() => setEditingPlayer(null)} onUpdate={handleUpdatePlayer} />
      )}
    </div>
  )
}
